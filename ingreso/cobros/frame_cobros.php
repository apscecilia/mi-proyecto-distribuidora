...
<html>
	<head>
		...
		/*function eliminar(codfactura,idmov,fechacobro,importe){			
			...
			function eliminar(codfactura,id,fechacobro,importe){			
			miPopup = window.open("eliminar.php?codfactura="+codfactura+"&id="+id+"&fechacobro="+fechacobro+"&importe="+importe,"frame_datos","width=380,height=240,scrollbars=yes");
		}
