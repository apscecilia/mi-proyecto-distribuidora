...
$query="SELECT * FROM remitos WHERE codalbaran='$codalbaran'";
...
<html>
	<head>
		...
		function aceptar(codalbaran) {
			location.href="guardar_remito.php?codalbaran=" + codalbaran + "&accion=baja" + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">ELIMINAR REMITO</div>
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					  ...
					  /*<? $sel_lineas="SELECT remilinea.*,articulos.*,familias.nombre as nombrefamilia FROM albalinea,articulos,familias WHERE albalinea.codalbaran='$codalbaran' AND albalinea.codigo=articulos.codarticulo AND albalinea.codfamilia=articulos.codfamilia AND articulos.codfamilia=familias.codfamilia ORDER BY albalinea.numlinea ASC";*/
