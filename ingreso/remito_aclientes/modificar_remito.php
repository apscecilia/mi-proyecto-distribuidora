...
$sel_alb="SELECT * FROM remitos WHERE codalbaran='$codalbaran'";
...
$sel_cliente="SELECT nombre,cuil FROM clientes WHERE codcliente='$codcliente'";
$rs_cliente=mysql_query($sel_cliente);
$nombre=mysql_result($rs_cliente,0,"nombre");
$cuil=mysql_result($rs_cliente,0,"cuil");

$fechahoy=date("Y-m-d");
$sel_albaran="INSERT INTO remitostmp (codalbaran,fecha) VALUE ('','$fechahoy')";
...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO remilineatmp (codalbaran,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codigo','$cantidad','$precio','$importe','$dcto')";//codfamilia,'$codfamilia',
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">INSERTAR REMITO </div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_remito.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">CUIL</td>
				            <td width="64%"><input NAME="cuil" type="text" class="cajaMedia" id="cuil" size="20" maxlength="15" value="<? echo $cuil?>" readonly></td>
						</tr>
						<? $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
