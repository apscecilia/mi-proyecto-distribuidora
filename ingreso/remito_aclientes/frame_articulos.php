...
<script language="javascript">
                      //codfamilia,
function pon_prefijo(pref,nombre,precio,codarticulo) {
...
<? if ($nrs>0) { ?>
        ...
        <div align="left"><?php echo $referencia;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo('<?php echo $referencia?>','<?php echo str_replace('"','',$descripcion)?>','<?php echo $precio?>',<? echo $codarticulo?>)"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>
                    <!--atencion pon prefijo(<?php echo $codfamilia?>,-->					
				</tr>
			<?php }
		?>
  </table>
