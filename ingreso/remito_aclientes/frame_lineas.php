...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO remilineatmp (codalbaran,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codarticulo','$cantidad','$precio','$importe','$descuento')";
...
<?php
$sel_lineas="SELECT remilineatmp.*,articulos.* FROM remilineatmp,articulos WHERE remilineatmp.codalbaran='$codalbarantmp' AND remilineatmp.codigo=articulos.codarticulo ORDER BY remilineatmp.numlinea ASC";
