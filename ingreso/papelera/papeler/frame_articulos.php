...
function pon_prefijo(pref,nombre,precio,codarticulo) {//codfamilia,
...
<? if ($nrs>0) { ?>
        ...
        <div align="center"><?php echo $nombrefamilia;?></div></td>-->
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codarticulo?>,'<?php echo $referencia?>','<?php echo str_replace('"','',$descripcion)?>','<?php echo $precio?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>		
