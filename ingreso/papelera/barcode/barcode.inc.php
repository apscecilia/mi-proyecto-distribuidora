<?php
	...
	/*
		Esta clase es para la generación de códigos de barras en las simbologías de codificación diffrenct.
* Soporta EAN-13, EAN-8, UPC-A, UPC-E, ISBN, 2 de 5 simbologías (std, ind, entrelazado), Postnet,
* Codabar, Código 128, Code39, Code93 simbologías.
*
* Este programa se distribuye con la esperanza de que sea útil,
* Pero SIN NINGUNA GARANTÍA, incluso sin la garantía implícita de
* COMERCIALIZACIÓN o IDONEIDAD PARA UN PROPÓSITO PARTICULAR.
*
* Requisitos: PHP con soporte para biblioteca GD.
*
* Referencia: http://www.barcodeisland.com/symbolgy.phtml
	*/
