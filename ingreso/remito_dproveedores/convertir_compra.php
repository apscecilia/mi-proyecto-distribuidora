...
$sel_orden="SELECT fecha FROM remitosp WHERE codalbaran='$codalbaran' AND codproveedor='$codproveedor'";//se_albaran
$rs_orden=mysql_query($sel_orden);//albaran
$fecha=mysql_result($rs_orden,0,"fecha");//albaran
$fecha=implota($fecha);
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">CONVERTIR ORDEN DE COMPRA</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_compra.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							<td width="14%">C&oacute;digo O.de Compra</td>
