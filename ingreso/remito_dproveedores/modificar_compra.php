...
$sel_alb="SELECT * FROM remitosp WHERE codalbaran='$codalbaran' AND codproveedor='$codproveedor'";
...
$sel_cliente="SELECT nombre,cuit FROM proveedores WHERE codproveedor='$codproveedor'";
$rs_cliente=mysql_query($sel_cliente);
$nombre=mysql_result($rs_cliente,0,"nombre");
$cuit=mysql_result($rs_cliente,0,"cuit");

$fechahoy=date("Y-m-d");
$sel_orden="INSERT INTO remitosptmp (codalbaran,fecha) VALUE ('','$fechahoy')";
$rs_orden=mysql_query($sel_orden);
...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO remilineaptmp (codalbaran,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codigo','$cantidad','$precio','$importe','$dcto')";//codfamilia,'$codfamilia',
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">MODIFICAR ORDEN DE COMPRA</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_compra.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">CUIT</td>
				            <td width="64%"><input NAME="nif" type="text" class="cajaMedia" id="cuit" size="20" maxlength="15" value="<? echo $cuit?>" readonly></td>
						</tr>
						<? $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
