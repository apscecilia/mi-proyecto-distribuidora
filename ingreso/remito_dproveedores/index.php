...
<html>
	<head>
		...
		function nueva_compra() {
			location.href="nueva_compra.php";
		}
	...
	<body onLoad="inicio()">
	  ...
	  <div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">BUSCAR ORDEN DE COMPRA</div>
				<div id="frmBusqueda">
        ...
        <script type="text/javascript">
				...
				<img src="../img/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar()" onMouseOver="style.cursor=cursor">
			 	  <img src="../img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonnuevacompra.jpg" width="106" height="22" border="1" onClick="nueva_compra()" onMouseOver="style.cursor=cursor">
				 
				</div>
			  <div id="lineaResultado">
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="50%" align="left">N Orden de compra encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
