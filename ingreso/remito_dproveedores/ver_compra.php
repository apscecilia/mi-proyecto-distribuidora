...
$query="SELECT * FROM remitosp WHERE codalbaran='$codalbaran' AND codproveedor='$codproveedor'";
...
<html>
	<head>
		...
		function imprimir(codalbaran,codproveedor) {
			location.href="../fpdf/imprimir_remito_proveedor.php?codalbaran="+codalbaran+"&codproveedor="+codproveedor;
		}
			...
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
						  <td>C&oacute;digo de O. de Compra</td>
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					  <? $sel_lineas="SELECT * FROM remilineap,articulos WHERE remilineap.codalbaran='$codalbaran' AND remilineap.codproveedor='$codproveedor' AND remilineap.codigo=articulos.codarticulo  ORDER BY remilineap.numlinea ASC";
$rs_lineas=mysql_query($sel_lineas);// alba   AND albalineap.codfamilia=articulos.codfamilia
