...
$fechahoy=date("Y-m-d");
$sel_remito="INSERT INTO remitosptmp (codalbaran,fecha) VALUE ('','$fechahoy')";
$rs_remito=mysql_query($sel_remito);
	...
	<head>
		...
		function abreVentana(){
			...
			if (bi==0) {
				...
				alert ("Ha comenzado la orden de compra. No puede cambiar de proveedor");
			}
		}
		...
		function validar_cabecera()
			{
				...
				if (document.getElementById("calbaran").value=="") mensaje+="  - Cod. Orden\n";
				if (mensaje!="") {
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm_nf" class="header">CREAR ORDEN DE COMPRA</div>
				...
				<form id="formulario" name="formulario" method="post" action="guardar_compra.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">CUIT</td>
				            <td width="64%"><input NAME="cuit" type="text" class="cajaMedia" id="cuit" size="20" maxlength="15" readonly></td>
						</tr>
						<? $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
