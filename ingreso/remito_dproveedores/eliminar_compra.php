...
<html>
	<head>
		...
		function aceptar(codalbaran,codproveedor) {
			location.href="guardar_compra.php?codalbaran=" + codalbaran + "&codproveedor=" + codproveedor + "&accion=baja" + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">ELIMINAR ORDEN DE COMPRA</div>
				<div id="frmBusqueda">
