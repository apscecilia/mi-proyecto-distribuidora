...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO remilineaptmp (codalbaran,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codalbarantmp','','$codarticulo','$cantidad','$precio','$importe','$descuento')";
...
<?php
$sel_lineas="SELECT remilineaptmp.*,articulos.* FROM remilineaptmp,articulos WHERE remilineaptmp.codalbaran='$codalbarantmp' AND remilineaptmp.codigo=articulos.codarticulo ORDER BY remilineaptmp.numlinea ASC";
