...
<html>
	<head>
		...
		function imprimir() {
			...
			window.open("../fpdf/clientes.php?codcliente="+codcliente+"&nombre="+nombre+"&cuil="+cuil+"&provincia="+provincia+"&localidad="+localidad+"&telefono="+telefono);
		}//
		...
		function hacer_cadena_busqueda() {
			...
			var telefono=document.getElementById("telefono").value;
			var cadena="";
			cadena="~"+codcliente+"~"+nombre+"~"+cuil+"~"+provincia+"~"+localidad+"~"+telefono+"~";
			return cadena;//
			}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="buscar.php" target="frame_buscar">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codcliente" type="text" class="cajaPequena" NAME="codcliente" maxlength="10" value="<? echo $codcliente?>"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
						...
						<tr>
						  <td>Cuil</td>
						  <td><input id="cuil" type="text" class="cajaPequena" NAME="cuil" maxlength="15" value="<? echo $cuil?>"></td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
					  </tr>
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="cabeceraResultado" class="header">VISUALIZAR</div>
				<div id="frmResultado">
