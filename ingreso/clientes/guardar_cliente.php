...
if ($accion=="alta") {
	$query_operacion="INSERT INTO clientes (codcliente, nombre, cuil,direccion, codprovincia, localidad, codformapago, codentidad, cuentabancaria, codpostal, telefono, movil, email, web, borrado) VALUES ('', '$nombre', '$cuil', '$direccion', '$codprovincia', '$localidad', '$codformapago', '$codentidad', '$cuentabanco', '$codpostal', '$telefono', '$movil', '$email', '$web', '0')";	//
...
if ($accion=="modificar") {
	...
	$query="UPDATE clientes SET nombre='$nombre',cuil='$cuil', direccion='$direccion', codprovincia='$codprovincia', localidad='$localidad', codformapago='$codformapago', codentidad='$codentidad', cuentabancaria='$cuentabanco', codpostal='$codpostal', telefono='$telefono', movil='$movil', email='$email', web='$web', borrado=0 WHERE codcliente='$codcliente'";//, nif='$nif'
...
if ($accion=="baja") {
	...
	$cuil=mysql_result($rs_mostrar,0,"cuil");
