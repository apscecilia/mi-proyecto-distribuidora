...
<form id="formulario" name="formulario" method="post" action="guardar_cobro.php" target="frame_datos">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=2 border=0>
						...
						<tr>
							<td>Importe</td>
						    <td><? echo $codigomonedate?> <input NAME="importe" type="text" class="cajaPequena" id="importe" size="10" maxlength="10" value="<? echo $importe?>" readonly></td>
			            </tr>
						<!--<tr>
							<td>Importe vale</td>
						    <td><? echo $codigomonedate?> <input NAME="importevale" type="text" class="cajaPequena" id="importevale" size="10" maxlength="10" value="0"> <img src="../img/disco.png" name="Image2" id="Image2" width="16" height="16" border="0" id="Image2" onMouseOver="this.style.cursor='pointer'" title="Aplicar Vale" onClick="actualizarimporte()"></td>
			            </tr>-->
						<tr>
							<td>A pagar</td>
						    <td><? echo $codigomonedate?> <input NAME="apagar" type="text" class="cajaPequena" id="apagar" size="10" maxlength="10" value="<? echo $importe?>" readonly></td>
			            </tr>
						<tr>
							<td>Pagado</td>
						    <td><? echo $codigomonedate?> <input NAME="pagado" type="text" class="cajaPequena" id="pagado" size="10" maxlength="10"> <img src="../img/dinero.jpg" name="Image2" id="Image2" width="16" height="16" border="0" id="Image2" onMouseOver="this.style.cursor='pointer'" title="Pagado" onClick="actualizarimportedevolver()"></td>
			            </tr>
						<tr>
							<td>A devolver</td>
						    <td><? echo $codigomonedate?> <input NAME="adevolver" type="text" class="cajaPequena" id="adevolver" size="10" maxlength="10" readonly></td>
			            </tr>
						<?
