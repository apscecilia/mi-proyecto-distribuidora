...
<html>
	<head>
		...
		function validarArticulo(){
			var codigo=document.getElementById("codart").value;//codbarras
			miPopup = window.open("comprobararticulo.php?codart="+codigo,"frame_datos","width=700,height=80,scrollbars=yes");//codbarras
		}		
		...
		function validar() 
			{
				...
				if (document.getElementById("codart").value=="") mensaje="  - Codigo articulo\n";//codbarras  -Codigo de barra 
				...
				if (mensaje!="") {
					...
					document.getElementById("codart").value="";//codbarras
		...
		function inicio() {
			...
			document.getElementById("codart").focus();//codbarras
			}
	...
	<body onload=inicio()>
        ...
        <script type="text/javascript">
					...
					button     : "Image1"
				            ...
				            <td width="3%">IVA</td>
                            <td width="64%"><input NAME="iva" type="text" class="cajaMinima" id="iva" size="5" maxlength="5" value="<? echo $ivaimp?>" onChange="cambio_iva()"> %</td>
						</tr>
					</table>										
			  ...
			  <div id="frmBusquedaVTASM">
				...
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0>
				  <tr>
					<td width="11%">Codigo articulo </td><!--barras-->
					<td colspan="10" valign="middle"><input NAME="codart" type="text" class="cajaMedia" id="codart" size="15" maxlength="15"> <img src="../img/calculadora.jpg" border="1" align="absmiddle" onClick="validarArticulo()" onMouseOver="style.cursor=cursor" title="Validar codigo ">     <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos()" onMouseOver="style.cursor=cursor" title="Buscar articulo"></td><!--codbarras-->
				  </tr>
				  <tr>
					<td>Descripcion</td>
			...
			<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
			  <tr>
				...
				<td width="73%" align="right"><div align="center"><? echo $base ?> <? echo $simbolomoneda ?>
			      <input class="cajaTotales" name="baseimponible" type="text" id="baseimponible" size="12" value="<? echo $baseimp ?>" align="right" readonly> 
		        </div></td>
			  </tr>
			  <tr>
				<td class="busqueda">IVA</td>
				<td align="right"><div align="center"><? echo $simbolomoneda ?>
			      <input class="cajaTotales" name="baseimpuestos" type="text" id="baseimpuestos" size="12" align="right" value="<? echo $baseiva ?>" readonly> 
		        </div></td>
			  </tr>
			  <tr>
				<td class="busqueda">Precio Total</td>
				<td align="right"><div align="center"><? echo $simbolomoneda ?>
			      <input class="cajaTotales" name="preciototal" type="text" id="preciototal" size="12" align="right" value="<? echo $preciotot ?>" readonly> 
		        </div></td>
			  </tr>
		</table>
			  </div>
			  ...
			  <br>
			 	<div id="botonBusqueda3_nf">					
			  	...
			  	<div id="lineaResultadoVTASM">
			  	  <iframe width="100%" height="365" id="frame_lineas" name="frame_lineas" frameborder="0"> <ilayer width="100%" height="250" id="frame_lineas" name="frame_lineas"></ilayer></iframe>
	  	          <iframe id="frame_datos" name="frame_datos" width="0" height="0" frameborder="0"> <ilayer width="0" height="0" id="frame_datos" name="frame_datos"></ilayer></iframe>
			  	</div>
			 </div>
		  </div>
		</div>
