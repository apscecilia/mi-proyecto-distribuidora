...
function pon_prefijo(pref,nombre,precio) {//codfamilia,
	//parent.opener.document.formulario_lineas.codarticulo.value=codarticulo;//codfamilia
	parent.opener.document.formulario_lineas.codart.value=pref;//codbarras
...
<?
	...
	$consulta="SELECT articulos.* FROM articulos WHERE ".$where." AND articulos.codarticulo AND articulos.borrado=0 ORDER BY articulos.codarticulo ASC,articulos.descripcion ASC";
...
<? if ($nrs>0) { ?>
		<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
		  <tr>
			<td width="15%"><div align="center"><b>Codigo</b></div></td><!--Familia-->
		...
		<?php
			for ($i = 0; $i < mysql_num_rows($rs_tabla); $i++) {
				$codarticulo=mysql_result($rs_tabla,$i,"codarticulo");//codfamilia
				...
				$precio=mysql_result($rs_tabla,$i,"precio_almacen");//precio_tienda
				 if ($i % 2) { $fondolinea="itemParTabla"; } else { $fondolinea="itemImparTabla"; }?>
						<tr class="<?php echo $fondolinea?>">
				<!--	<td>
        <div align="center"><?php echo $nombrefamilia;?></div></td>-->
        			<td><div align="left"><?php echo $codarticulo;?></div></td>
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codarticulo?>,'<?php echo str_replace('"','',$descripcion)?>','<?php echo $precio?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>		
                   
                    <!--copia arriva =<td align="center"><div align="center"><a href="javascript:pon_prefijo(<?php echo $codfamilia?>,'<?php echo $codigobarras?>','<?php echo str_replace('"','',$descripcion)?>','<?php echo $precio?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>		-->			
				</tr>
			<?php }
		?>
  </table>
