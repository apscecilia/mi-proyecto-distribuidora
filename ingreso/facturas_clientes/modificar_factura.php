...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO factulineatmp (codfactura, numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codfacturatmp','','$codigo','$cantidad','$precio','$importe','$dcto')";//codfamilia,  '$codfamilia',
        ...
        <script type="text/javascript">
			  ...
			  <div id="frmBusqueda">
				...
				<div id="lineaResultadoAW">
				  <iframe width="100%" height="250" id="frame_lineas" name="frame_lineas" frameborder="0"> <ilayer width="100%" height="250" id="frame_lineas" name="frame_lineas"></ilayer></iframe>
