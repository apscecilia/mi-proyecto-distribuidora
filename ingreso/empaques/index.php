...
<html>
	<head>
		...
		function nuevo_empaque() {
			location.href="nuevo_empaque.php";
		}
		...
		function imprimir() {
			...
			window.open("../fpdf/empaque.php?codembalaje="+codembalaje+"&nombre="+nombre);
		}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="buscar.php" target="frame_buscar">
			 	...
			 	<div id="botonBusqueda">
			 	  ...
			 	  <img src="../img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar_busqueda()" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonnuevoempaque.jpg" width="118" height="22" border="1" onClick="nuevo_empaque()" onMouseOver="style.cursor=cursor">
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="50%" align="left">N de empaques encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
				<td width="50%" align="right">Mostrados <select name="paginas" id="paginas" onChange="paginar()">
		          </select></td>
			  </table>
				</div>
				<div id="cabeceraResultado" class="header">
					VISUALIZACI&Oacute;N</div>
				<div id="frmResultado">
