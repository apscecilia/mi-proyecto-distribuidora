...
$query="SELECT * FROM empaques WHERE codembalaje='$codembalaje'";
...
<html>
	<head>
		...
		function aceptar(codembalaje) {
			location.href="guardar_empaque.php?codembalaje=" + codembalaje + "&accion=baja" + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">ELIMINAR EMPAQUE </div>
				<div id="frmBusqueda">
