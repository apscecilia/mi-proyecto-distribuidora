...
if ($modif<>1) {
		...
		if ($retorno==0) {	
				...
				$sel_insert="INSERT INTO factulineaptmp (codfactura,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codfacturatmp','','$codarticulo','$cantidad','$precio','$importe','$descuento')";//codfamilia,  '$codfamilia',
...
<?php
$sel_lineas="SELECT factulineaptmp.*,articulos.*  FROM factulineaptmp,articulos WHERE factulineaptmp.codfactura='$codfacturatmp' AND factulineaptmp.codigo=articulos.codarticulo  ORDER BY factulineaptmp.numlinea ASC";
