...
$sel_cliente="SELECT nombre,cuit FROM proveedores WHERE codproveedor='$codproveedor'";//cuit
...
while ($contador < mysql_num_rows($rs_lineas)) {
	...
	$sel_tmp="INSERT INTO factulineaptmp (codfactura,numlinea,codigo,cantidad,precio,importe,dcto) VALUES ('$codfacturatmp','','$codigo','$cantidad','$precio','$importe','$dcto')";//codfamilia, '$codfamilia',
				...
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
				            ...
				            <td width="3%">CUIT</td>
				            <td width="64%"><input NAME="cuit" type="text" class="cajaMedia" id="cuit" size="20" maxlength="15" value="<? echo $cuit?>" readonly></td>
						</tr>
						<? $hoy=date("d/m/Y"); ?>
						<tr>
							<td width="6%">Fecha</td>
