		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					  <? $sel_lineas="SELECT * FROM factulineap,articulos WHERE factulineap.codfactura='$codfactura' AND factulineap.codproveedor='$codproveedor' AND factulineap.codigo=articulos.codarticulo ORDER BY factulineap.numlinea ASC";// AND factulineap.codfamilia=articulos.codfamilia
