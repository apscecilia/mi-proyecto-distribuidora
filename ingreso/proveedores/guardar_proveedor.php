...
if ($accion=="alta") {
	$query_operacion="INSERT INTO proveedores (codproveedor, nombre,cuit, direccion, codprovincia, localidad, codentidad, 			cuentabancaria, codpostal, telefono, movil, email, web, borrado) 
					VALUES ('', '$nombre','$cuit', '$direccion', '$codprovincia', '$localidad', '$codentidad', '$cuentabanco', '$codpostal', '$telefono', '$movil', '$email', '$web', '0')";			//borre		, nif   , '$nif'
...
if ($accion=="modificar") {
	...
	$query="UPDATE proveedores SET nombre='$nombre',cuit='$cuit', direccion='$direccion', codprovincia='$codprovincia', localidad='$localidad', codentidad='$codentidad', cuentabancaria='$cuentabanco', codpostal='$codpostal', telefono='$telefono', movil='$movil', email='$email', web='$web', borrado=0 WHERE codproveedor='$codproveedor'";//borre , nif='$nif'
...
if ($accion=="baja") {
	...
	$cuit=mysql_result($rs_mostrar,0,"cuit");
