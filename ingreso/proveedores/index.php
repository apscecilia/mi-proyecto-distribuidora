...
<html>
	<head>
		...
		function imprimir() {
			...
			window.open("../fpdf/proveedores.php?codproveedor="+codproveedor+"&nombre="+nombre+"&provincia="+provincia+"&localidad="+localidad+"&telefono="+telefono);//borre "&nif="+nif+
		}
		...
		function hacer_cadena_busqueda() {
			...
			var telefono=document.getElementById("telefono").value;
			var cadena="";
			cadena="~"+codproveedor+"~"+nombre+"~"+provincia+"~"+localidad+"~"+telefono+"~";// borre "~"+nif+
			return cadena;
			}
			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="buscar.php" target="frame_buscar">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="codproveedor" type="text" class="cajaPequena" NAME="codproveedor" maxlength="10" value="<? echo $codproveedor?>"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
						...
						<tr>
						  <td>CUIT</td>
						  <td><input id="cuit" type="text" class="cajaPequena" NAME="cuit" maxlength="15" value="<? echo $cuit?>"></td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
					  </tr>
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div id="lineaResultado_pagos">
					...
					<ilayer width="0" height="0" id="frame_datos" name="frame_datos"></ilayer>					</iframe>
				</div>
			</div>
		  </div>			
		</div>
