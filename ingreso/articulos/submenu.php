...
if ($codproveedor > "0") { $where.=" AND (codproveedor1='$codproveedor' )"; }
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							...
							<td class="aCentro" width="11%"><div align="center"><? echo mysql_result($res_resultado,$contador,"precio_almacen")?></div></td>
