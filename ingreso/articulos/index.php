...
<html>
	<head>
		...
		function imprimir() {
			...
			window.open("../fpdf/articulos.php?codarticulo="+codarticulo+"&referencia="+referencia+"&descripcion="+descripcion+"&proveedores="+proveedores+"&ubicacion="+ubicacion);
		}//"&familia="+familia+
		...
		function hacer_cadena_busqueda() {
			...
			var ubicacion=document.getElementById("cboUbicacion").value;
			var cadena="";
			cadena="~"+codarticulo+"~"+referencia+"~"+descripcion+"~"+proveedores+"~"+ubicacion+"~";
			return cadena;//"~"+familia+
			}
...
-->
	...
	<body onLoad="inicio()">
		<div class="mensajeminimo" id="pagina">
<div id="zonaContenido">
				<div align="center">
				<div class="header Estilo1" id="tituloForm">ARTICULO </div>
                <div id="frmBusqueda">				
				<form id="form_busqueda" name="form_busqueda" method="post" action="submenu.php" target="frame_buscar">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							<td width="16%">C&oacute;digo de art&iacute;culo </td>
                            <td width="68%"><input id="codarticulo" type="text" class="cajaPequena" NAME="codarticulo" maxlength="15" value="<? echo $codarticulo?>"></td>
                           <!-- <td width="68%"><input id="codarticulo" type="text" class="cajaPequena" NAME="codarticulo" maxlength="15" value="<? echo $codarticulo?>" readonly="yes">																						                             </td>
					  ...
					  ?>
						...
						<?php
					  	$query_proveedores="SELECT codproveedor,nombre FROM proveedores WHERE borrado=0 ORDER BY nombre ASC";//,nif 
					  ...
					  ?>
						<tr>
							...
							<option value="0">Todos los proveedores</option>
								...
								<? } else { ?> 
								<option value="<?php echo mysql_result($res_proveedores,$contador,"codproveedor")?>"><?php echo mysql_result($res_proveedores,$contador,"codproveedor")?> -- <?php echo mysql_result($res_proveedores,$contador,"nombre")?></option>
								<? }
								$contador++;
								} ?>				
								</select>							</td>
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
				...
				<div class="header Estilo1" id="cabeceraResultado">
					VISUALIZADOR</div>
				<div id="frmResultado">
				...
				<div id="lineaResultado_pagos">
					<iframe width="100%" height="250" id="frame_buscar" name="frame_buscar" frameborder="0">
						<ilayer width="100%" height="250" id="frame_buscar" name="frame_buscar"></ilayer>
					</iframe>
				</div>
			</div>
		  </div>			
