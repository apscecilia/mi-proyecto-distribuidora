...
<?
       ...
       // $foto_name="";
		$query_operacion="INSERT INTO articulos (codarticulo,  referencia, descripcion, impuesto, codproveedor1,  codubicacion, stock, stock_minimo, aviso_minimo,  fecha_alta,codembalaje,  unidades_caja,  precio_compra, precio_almacen, borrado) 
						VALUES ('',  '$referencia', '$descripcion', '$codimpuesto', '$codproveedor1',  '$codubicacion', '$stock', '$stock_minimo', '$aviso_minimo',  '$fecha', '$codembalaje', '$unidades_caja','$precio_compra', '$precio_almacen',  '0')";	/*codfamilia,descripcion_corta,	datos_producto,	precio_ticket, modificar_ticket, observaciones,precio_tienda,codproveedor2, imagen, '$codfamilia', '$codproveedor2','$descripcion_corta','$datos',, '$precio_ticket', '$modificar_ticket', '$observaciones', '$precio_tienda', precio_iva,  '$precio_iva','$foto_name', codigobarras,'',*/
...
if ($accion=="modificar") {
	...
	$query="UPDATE articulos SET referencia='$referencia', descripcion='$descripcion', impuesto='$codimpuesto', codproveedor1='$codproveedor1', codubicacion='$codubicacion', stock='$stock', stock_minimo='$stock_minimo', aviso_minimo='$aviso_minimo', fecha_alta='$fecha',codembalaje='$codembalaje',  unidades_caja='$unidades_caja', precio_compra='$precio_compra', precio_almacen='$precio_almacen', borrado=0 WHERE codarticulo='$codarticulo'";/* codfamilia='$codfamilia', descripcion_corta='$descripcion_corta',, datos_producto='$datos'precio_ticket='$precio_ticket', modificar_ticket='$modif_descrip', observaciones='$observaciones',  precio_tienda='$precio_tienda',  codproveedor2='$codproveedor2', precio_iva='$precio_iva',, codigobarras='$codigobarras',".$cadena." */
			...
			<div id="zonaContenido">
				...
				<div id="frmBusqueda">
					...
					<!--	<tr>
						...
						<?php
					  	if ($codembalaje<>0) {
							$query_embalaje="SELECT * FROM empaques WHERE codembalaje='$codembalaje'";
