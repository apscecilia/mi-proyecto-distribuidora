					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
					  ...
					  ?>
						...
						$proveedor1=mysql_result($rs_query,0,"codproveedor1");
					  	$query_proveedores="SELECT codproveedor as codproveedor1,nombre FROM proveedores WHERE borrado=0 ORDER BY nombre ASC";
					  ...
					  ?>
						<tr>
							...
							<? } ?>
								...
								<option value="<?php echo mysql_result($res_proveedores,$contador,"codproveedor1")?>" selected><?php echo mysql_result($res_proveedores,$contador,"codproveedor1")?> -- <?php echo mysql_result($res_proveedores,$contador,"nombre")?></option>
								<? } else { ?> 
								<option value="<?php echo mysql_result($res_proveedores,$contador,"codproveedor1")?>"><?php echo mysql_result($res_proveedores,$contador,"codproveedor1")?> -- <?php echo mysql_result($res_proveedores,$contador,"nombre")?></option>
								<? }
								$contador++;
								} ?>				
								</select>							</td>
