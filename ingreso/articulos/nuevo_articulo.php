...
<html>
	<head>
		<title>Principal</title><!--calendario-->
                    ...
                    <div id="frmBusqueda">
						...
						<form id="formulario" name="formulario" method="post" action="guardar_articulo.php" enctype="multipart/form-data">
							...
							<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
								...
								<?php
									$query_proveedores="SELECT codproveedor,nombre FROM proveedores WHERE borrado=0 ORDER BY nombre ASC";
									$res_proveedores=mysql_query($query_proveedores);//,nif 
									$contador=0;
								?>
								<tr>
									<td>Proveedor</td>
									...
									<?php
										while ($contador < mysql_num_rows($res_proveedores)) { 
											if ( mysql_result($res_proveedores,$contador,"codproveedor") == $proveedor) { ?>
												<option value="<?php echo mysql_result($res_proveedores,$contador,"codproveedor")?>" selected><?php echo mysql_result($res_proveedores,$contador,"codproveedor")?> -- <?php echo mysql_result($res_proveedores,$contador,"nombre")?></option>
											<? } else { ?> 
								...
								<?php
								$query_embalaje="SELECT codembalaje,nombre FROM empaques WHERE borrado=0 ORDER BY nombre ASC";
								...
								<tr>
									...
									<option value="0">Todos los empaques</option>
									<?php
