...
if ($cadena_busqueda<>"") {
	...
	$numremitoini=$array_cadena_busqueda[3];//$numalbaranin
	//$numremitofin=$array_cadena_busqueda[4];//$numalbaranin
	$fechainicio=$array_cadena_busqueda[5];
	$fechafin=$array_cadena_busqueda[6];
} else {
	$codcliente="";
	$nombre="";
	$numremitoini="";//$numalbaranin
	//$numremitofin="";//$numalbaranfin
	$fechainicio="";
	$fechafin="";
}
...
<html>
	<head>
		...
		function facturar_remito() {
			var cadena_elegidos="";
			cadena_elegidos=devolver_cadena_checks("frame_rejilla","checkbox_socio");
			if (opciones==0)  {
				alert("No hay remito seleccionados.");
			} else {
				if (confirm("Va a facturar "+opciones+ "remito . Desea continuar?")) {
					window.location.href="configurar_lote.php?cadena_busqueda="+cadena_busqueda+"&cadena_elegidos="+cadena_elegidos;//guia despacho
					}
			}
		}
		...
		function hacer_cadena_busqueda() {
			...
			var nombre=document.getElementById("nombre").value;
			var numremitoini=document.getElementById("numremitoini").value;//numalbaranini			
			//var numremitofin=document.getElementById("numremitofin").value;//numalbaranfin
			var fechainicio=document.getElementById("fechainicio").value;
			var fechafin=document.getElementById("fechafin").value;
			var cadena="";
			cadena="~"+codcliente+"~"+nombre+"~"+numremitoini+"~"+fechainicio+"~"+fechafin+"~";//+numremitofin+"~"
			return cadena;
			}
	...
	<body>
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">REMITO</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="buscar.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
							<td>CUIL</td>
							<td><input id="cuil" name="cuil" type="text" class="cajaMedia" maxlength="20" readonly="yes"></td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
						...
						<tr>
						  <td>Num. remito</td>
						  <td><input id="numremitoini" type="text" class="cajaPequena" NAME="numremitoini" maxlength="15" value="<? echo $numremitoini?>"></td><!--numalbaranini    $numalbaranini-->
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
					  </tr>
					<!--<tr>
						 <td>Num. guia despacho Final</td>
						  <td><input id="numremitofin" type="text" class="cajaPequena" NAME="numremitofin" maxlength="15" value="<? echo $numremitofin?>"></td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
						  <td>&nbsp;</td>
					  </tr>-->
        ...
        <script type="text/javascript">
				...
				<img src="../img/botonbuscar.jpg" width="69" height="22" border="1" onClick="buscar()" onMouseOver="style.cursor=cursor">
			 	  <img src="../img/botonlimpiar.jpg" width="69" height="22" border="1" onClick="limpiar()" onMouseOver="style.cursor=cursor">
					 <img src="../img/botonfacturaremito.jpg" width="131" height="22" border="1" onClick="facturar_remito()" onMouseOver="style.cursor=cursor">						
				</div>
			  <div id="lineaResultado">
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
			  	<tr>
				<td width="50%" align="left">N. de remitos encontrados <input id="filas" type="text" class="cajaPequena" NAME="filas" maxlength="5" readonly></td>
				<td width="50%" align="right">Mostrados <select name="paginas" id="paginas" onChange="paginar()">
		          </select></td>
			  </table>
				</div>
				<div id="cabeceraResultado" class="header">VISUALIZADOR</div>
				<div id="frmResultado">
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
						<tr class="cabeceraTabla">
							<td width="10%"><input name="todos" type="checkbox" value="todos" onClick="activartodos()"></td>
							<td width="15%">ITEM</td>
							<td width="25%">N.REMITO </td>
