...
$select_remitos="SELECT * FROM remitos WHERE codalbaran IN (".$remitos.")";
$rs_remitos=mysql_query($select_remitos); 

$contador=0;

while ($contador < mysql_num_rows($rs_remitos)) {
	$codalbaran=mysql_result($rs_remitos,$contador,"codalbaran");
	...
	$sel_lineas="SELECT * FROM remilinea WHERE codalbaran='$codalbaran'";
...
$act_alb="UPDATE remitos SET codfactura='$codfactura',estado=2 WHERE codalbaran IN (".$remitos.")";
$rs_alb=mysql_query($act_alb);

	$cabecera1="Inicio >> Ventas &gt;&gt; Facturar Remitos ";
	$cabecera2="FACTURAR REMITOS";
?>
...
$rs_lineas=mysql_query($sel_lineas);
			      ...
			      $preciototal=number_format($preciototal,2,".",",");
					...
					<table width="25%" border=0 align="right" cellpadding=3 cellspacing=0 class="fuente8">
						<tr>
							<td width="15%">Neto</td>
							<td width="15%"><? echo $simbolomoneda ?><?php echo number_format($baseimponible,2,".",",");?></td>
						</tr>
						<tr>
							<td width="15%">IVA</td>
							<td width="15%"><? echo $simbolomoneda ?><?php echo number_format($baseimpuestos,2,".",",");?></td>
						</tr>
						<tr>
							<td width="15%">Total</td>
							<td width="15%"><? echo $simbolomoneda ?><?php echo $preciototal?></td>
						</tr>
					</table>
			  </div>
