...
<html>
	<head>
		...
		function ver_pagos(codfactura,codproveedor) {
			parent.location.href="ver_pagos.php?codfactura=" + codfactura + "&codproveedor=" + codproveedor + "&cadena_busqueda=<? echo $cadena_busqueda?>";
		}
			...
			<input type="hidden" name="numfilas" id="numfilas" value="<? echo $filas?>">
				<?	if ($filas > 0) { ?>
						...
						<tr class="<?php echo $fondolinea?>">
							<!--<td class="aCentro" width="5%"><input type="checkbox" name="checkbox_socio" id="checkbox_socio" value="<? echo mysql_result($res_resultado,$contador,"codfactura")?>" style="border:0"></td>-->
							...
							<td width="21%"><div align="left"><? echo mysql_result($res_resultado,$contador,"nombre")?></div></td>							
							<td width="9%"><div align="right"><? echo number_format(mysql_result($res_resultado,$contador,"totalfactura"),2,".",",")?></div></td>
							...
							<td class="aDerecha" width="10%"><div align="right"><? echo number_format($pendiente,2,".",",")?></div></td>
							...
							<td width="5%"><div align="center"><a href="#"><img src="../img/dinero.jpg" width="16" height="16" border="0" onClick="ver_pagos('<?php echo mysql_result($res_resultado,$contador,"codfactura")?>',<?php echo mysql_result($res_resultado,$contador,"codproveedor")?>)" title="Ver Pagos"></a></div></td>
						</tr>
						<? $contador++;
							}
						?>			
