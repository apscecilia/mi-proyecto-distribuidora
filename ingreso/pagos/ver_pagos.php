...
$sel_pagos="SELECT sum(importe) as aportaciones FROM pagos WHERE codfactura='$codfactura' AND codproveedor='$codproveedor'";
$rs_pagos=mysql_query($sel_pagos);
				...
				<form id="formulario" name="formulario" method="post" action="frame_pagos.php" target="frame_pagos">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
						    ...
						    <td width="35%"><input id="fechapago2" type="text" class="cajaPequena" NAME="fechapago2" maxlength="10" value="<? echo $hoy?>" readonly><img src="../img/calendario.png" name="Image3" id="Image3" width="16" height="16" border="0" id="Image3" onMouseOver="this.style.cursor='pointer'" title="Calendario">
        <script type="text/javascript">
					Calendar.setup(
					  {
			  ...
			  <div id="cabeceraResultadoNNN" class="header">
				...
				<table class="fuente8" width="100%" cellspacing=0 cellpadding=3 border=0 ID="Table1">
					...
					<iframe width="100%" height="250" id="frame_pagos" name="frame_pagos" frameborder="0" src="frame_pagos.php?accion=ver&codfactura=<? echo $codfactura?>&codproveedor=<? echo $codproveedor?>">
