...
<?
	...
	for ($i = 0; $i < mysql_num_rows($rs_lineas); $i++) { 	
		...
		<tr>
			...
			<td width="18%" class="Estilo3"><div align="rigth"><? echo $precio ?></div></td>
			<td width="3%" class="Estilo3"><div align="rigth"><? echo $descuento ?> % </div></td>
			<td width="10%" class="Estilo3"><div align="rigth"><? echo number_format($importe,2,".",","); ?> </div></td>
  		</tr>
		<?
	}
